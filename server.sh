...
lt --port 3001 --subdomain blumen &
docker run --name blumen -p 3001:2368 -e url=https://blumen.localtunnel.me -v $volume emilol/docker-ghost-cloudinary bash -c "$config"
